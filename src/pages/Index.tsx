        ...
        <div className="container mx-auto px-4 py-6">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              <div className="w-12 h-12 bg-gradient-to-r from-blue-500 via-purple-500 to-cyan-500 rounded-xl flex items-center justify-center shadow-xl shadow-blue-500/25">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground font-medium">AI-Powered Cultural Translation</p>
              </div>
            </div>
            <div className="flex items-center space-x-4">
              <Badge variant="secondary" className="bg-gradient-to-r from-emerald-100 to-blue-100 dark:from-emerald-900/30 dark:to-blue-900/30 text-emerald-700 dark:text-emerald-300 px-3 py-1">
          ...
          <TabsContent value="translate" className="space-y-8">
            ...
            <div className="grid lg:grid-cols-2 gap-8">
              ...
              <Card className="shadow-2xl border-0 bg-card/90 backdrop-blur-sm">
                <CardHeader className="bg-gradient-to-r from-blue-50/80 to-purple-50/80 dark:from-blue-950/30 dark:to-purple-950/30 rounded-t-lg">
                  ...
                  <Tabs defaultValue="text" className="w-full">
                    ...
                    <TabsContent value="text" className="space-y-4">
                      <Textarea
                        ...
                        className="min-h-[200px] resize-none border-2 focus:border-blue-400 dark:focus:border-blue-500 transition-colors bg-background/50"
                      />
                    ...
                    <TabsContent value="file" className="space-y-4">
                      <div className="border-2 border-dashed border-muted-foreground/30 rounded-lg p-8 text-center hover:border-blue-400 dark:hover:border-blue-500 transition-colors cursor-pointer bg-muted/20">
